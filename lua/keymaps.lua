...
keymap.set("n", "<Leader>gc", require("telescope.builtin").git_commits, { desc = "Search [G]it [C]ommits" })
keymap.set("n", "<Leader>sf", require("telescope.builtin").find_files, { desc = "[S]earch [F]iles" })
keymap.set("n", "<Leader>ss", require("telescope.builtin").symbols, { desc = "[S]earch [S]ymbols" })
